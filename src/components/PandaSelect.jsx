...
/**
 * PandaSelect - Un componente de selección premium que evita los estilos nativos de Windows.
...
const PandaSelect = ({ 
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (
        ...
        !event.target.closest('.panda-select-dropdown')
      ) {
        setIsOpen(false);
      }
    };
  ...
  useEffect(() => {
    ...
    const close = (e) => {
      ...
      if (e.target && e.target.closest && e.target.closest('.panda-select-dropdown')) return;
      setIsOpen(false);
    };
  ...
  const dropdown = isOpen ? (
    <div
      className="panda-select-dropdown panda-scrollbar"
      style={{
        ...dropdownStyle,
      ...
      {createPortal(
        <>
          ...
          <style>{`
            ...
            .panda-select-dropdown.panda-scrollbar::-webkit-scrollbar {
              width: 6px;
              display: block !important;
            }
            .panda-select-dropdown.panda-scrollbar::-webkit-scrollbar-thumb {
