...
export default function PrizeWheel({ clientId, onWin }) {
  ...
  const handleSpin = async () => {
    ...
    // Segments: 3 sections = 120deg each.
    // Index 0: 0 to 120deg. Index 1: 120 to 240deg. Index 2: 240 to 360deg.
  ...
  return (
    <div className="glass-card" style={{ padding: '24px', textAlign: 'center', margin: '20px 0', border: '1px solid rgba(255,255,255,0.15)', borderRadius: '24px', background: 'rgba(255,255,255,0.02)' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', marginBottom: '16px' }}>
        ...
        <h2 style={{ fontSize: '18px', fontWeight: '900', textTransform: 'uppercase', letterSpacing: '1px' }}>¡Eres un Cliente Top del Mes!</h2>
      </div>
      <p style={{ fontSize: '13px', color: 'var(--text-muted)', marginBottom: '24px' }}>
        Tienes un giro gratis en la Ruleta Panda para ganar premios exclusivos.
      </p>
        ...
        <div style={{ position: 'relative', width: '220px', height: '220px', margin: '0 auto 24px' }}>
          ...
          <div 
            ...
            style={{
              ...
              background: 'conic-gradient(#fbbf24 0deg 120deg, #007aff 120deg 240deg, #32d74b 240deg 360deg)',
              position: 'relative',
              overflow: 'hidden',
          ...
          >
            {/* Sector Texts */}
            <div style={{ position: 'absolute', transform: 'rotate(60deg) translateY(-60px)', top: '50%', left: '50%', transformOrigin: '0 0', color: 'black', fontWeight: '900', fontSize: '11px', whiteSpace: 'nowrap' }}>10% OFF</div>
            <div style={{ position: 'absolute', transform: 'rotate(180deg) translateY(-60px)', top: '50%', left: '50%', transformOrigin: '0 0', color: 'white', fontWeight: '900', fontSize: '11px', whiteSpace: 'nowrap' }}>LAVADO</div>
            <div style={{ position: 'absolute', transform: 'rotate(300deg) translateY(-60px)', top: '50%', left: '50%', transformOrigin: '0 0', color: 'black', fontWeight: '900', fontSize: '11px', whiteSpace: 'nowrap' }}>GRATIS</div>
          </div>
