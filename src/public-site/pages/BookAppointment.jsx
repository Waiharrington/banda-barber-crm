...
import barberiaCover from '../../assets/barberia_cover.webp';
import tatuajesCover from '../../assets/tatuajes_cover.webp';
...
import heroSlide4 from '../../assets/hero4.webp';
            ...
            {heroSlides.map((slide, index) => (
              <div 
                ...
                style={{
                  ...
                  backgroundPosition: isDesktop ? (index === 0 ? '98% 25%' : '80% 20%') : '100% 33%',
            ...
            <div className="max-w-[1440px] mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-0 items-center justify-items-center">
              ...
              <div className="flex items-center gap-5 w-full md:justify-center md:border-r md:border-white/5 px-6 reveal-item delay-100 animate-float-subtle" style={{ animationDelay: '0ms' }}>
                ...
                <div className="flex flex-col text-left">
                  <span className="text-xl lg:text-2xl font-extrabold text-white tracking-tight leading-tight shimmer-text-gold" style={{ animationDelay: '0s' }}>TRAYECTORIA</span>
                  <span className="text-xs text-white/50 font-medium">Una cultura de estilo desde 2018</span>
                </div>
              </div>
              {/* Stat 2 */}
              <div className="flex items-center gap-5 w-full md:justify-center md:border-r md:border-white/5 px-6 reveal-item delay-200 animate-float-subtle" style={{ animationDelay: '300ms' }}>
                ...
                <div className="flex flex-col text-left">
                  <span className="text-xl lg:text-2xl font-extrabold text-white tracking-tight leading-tight shimmer-text-gold" style={{ animationDelay: '1.2s' }}>PRECISIÓN</span>
                  <span className="text-xs text-white/50 font-medium">Cada detalle trabajado con intención</span>
                </div>
              </div>
              {/* Stat 3 */}
              <div className="flex items-center gap-5 w-full md:justify-center md:border-r md:border-white/5 px-6 reveal-item delay-300 animate-float-subtle" style={{ animationDelay: '600ms' }}>
                ...
                <div className="flex flex-col text-left">
                  ...
                  <span className="text-xs text-white/50 font-medium">Especialistas en un solo lugar</span>
                </div>
              </div>
              {/* Stat 4 */}
              <div className="flex items-center gap-5 w-full md:justify-center px-6 reveal-item delay-400 animate-float-subtle" style={{ animationDelay: '900ms' }}>
                ...
                <div className="flex flex-col text-left">
                  <span className="text-xl lg:text-2xl font-extrabold text-white tracking-tight leading-tight shimmer-text-gold" style={{ animationDelay: '3.6s' }}>EXPERIENCIA PANDA</span>
                  <span className="text-xs text-white/50 font-medium">Atención, ambiente y estilo en San Jacinto</span>
                </div>
              </div>
            </div>
          </div>
                   ...
                   >
                     {barbers.length === 0 ? (
                      ...
                      barbers.filter(barber => {
                       ...
                       const specialtyText = (barber.specialty || '').trim() 
                          ? barber.specialty.trim().toUpperCase() 
                          : (isAbraham ? 'MASTER BARBER' : isAlejandro ? 'BARBERO' : isAngel ? 'BARBERO' : isJose ? 'TATUADOR' : isMarko ? 'TATUADOR' : (isBarista ? 'BARISTA' : isAsistente ? 'ASISTENTE DE LAVADO' : (isRawRolePermissions ? 'ESTILISTA' : rawRole.toUpperCase())));
                       ...
                       const defaultTags = isBarista ? 'Café • Bebidas • Experiencia' : (isAsistente ? 'Cuidado Capilar • Lavado • Confort' : (specialtyText.includes('TATUA') || rawRole.toLowerCase().includes('tatu') ? 'Realismo • Black & Grey' : (specialtyText.includes('MANICUR') || specialtyText.includes('UÑA') ? 'Manicura • Nails • Arte' : 'Corte • Barba • Estilo')));
                       const tagsText = !isRawPermissions 
                          ? cleanTags 
                          : (isAbraham ? 'Fade • Barba • Clásicos' : isAlejandro ? 'Corte • Barba • Diseños' : isAngel ? 'Fade • Corte • Barba' : isJose ? 'Realismo • Black & Grey' : isMarko ? 'Realismo • Black & Grey' : defaultTags);
                ...
                <div className="w-full bg-[#111115]/30 border border-white/[0.04] rounded-3xl overflow-hidden flex flex-col lg:flex-row items-stretch group hover:border-[rgba(203,183,154,0.12)] transition-all duration-500">
                  ...
                  <div className="flex-1 p-8 lg:p-12 text-left space-y-8 flex flex-col justify-center">
                    <div className="space-y-3">
                      ...
                      <h3 className="text-3xl lg:text-4xl font-extrabold text-white tracking-tight uppercase font-sans">
                        {topBarber.name}
                      </h3>
